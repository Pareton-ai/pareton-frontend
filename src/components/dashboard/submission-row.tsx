...
export function SubmissionRow({
  ...
  return (
    ...
    <tr className="group relative border-t border-border/80 transition-colors [clip-path:inset(0)] [transform:translate(0)] hover:bg-accent-dim/30 focus-within:bg-accent-dim/30">
      ...
      <td
        aria-hidden
        className="px-5 py-3.5 text-right font-mono text-body-sm text-muted opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100 sm:px-6"
      >
        →
      </td>
    </tr>
