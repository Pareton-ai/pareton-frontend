...
- **Workload:** either one fixed trace, or a pinned HuggingFace dataset revision (`sampling_rule`) that each **round** draws its prompts from; see [Dynamic workloads](/docs/platform/dynamic-workloads).
